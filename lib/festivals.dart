                        ...
                        child: Column(children: [
                            ...
                            child: FlatButton(
                              onPressed: () {
                                if (button[3]) {
                                  ...
                                  print("subscribe");
                                  api.user_subscribe(festivals[blockIdx]["shifts"][childIdx]["idshifts"].toString()).then((value) => {
                                    update()
                                  });
                                } else {
                                  print("unsubscribe");
                                  api.user_unsubscribe(festivals[blockIdx]["shifts"][childIdx]["idshifts"].toString()).then((value) => {
                                    update()
                                  }
                                  );
                                }
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int childIdxx) {
                              ...
                              return Container(
                                  decoration:
                                      BoxDecoration(color: Colors.lightBlueAccent, border: Border.all(color: Colors.black), borderRadius: BorderRadius.all(Radius.circular(10))),
